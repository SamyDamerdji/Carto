          ...
          >
            <div className="relative h-full w-full overflow-hidden rounded-xl">
              <Image
                ...
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-white/80 to-transparent to-80%" />
              <div className="absolute bottom-0 left-0 p-2 md:p-3">
                <h3 className="font-headline text-sm md:text-base font-bold text-black">
                  {card.nom_carte}
                </h3>
              </div>
            </div>

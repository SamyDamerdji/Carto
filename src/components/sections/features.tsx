...
const FeatureCard = ({ feature, index }: { feature: (typeof features)[0], index: number }) => {
  return (
    <motion.div
      ...
      className="relative h-full overflow-hidden rounded-2xl border border-primary bg-secondary/20 p-6 shadow-lg shadow-primary/20 backdrop-blur-lg"
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <div className="mt-4 flex-grow rounded-lg bg-card-foreground/20 p-4">

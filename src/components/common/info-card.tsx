...
export function InfoCard({ icon: Icon, title, children }: InfoCardProps) {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-primary/30 bg-secondary/20 p-6 shadow-lg shadow-primary/20 backdrop-blur-lg">
      ...
      <div className="relative z-10">
        ...
        <div className="mt-4 rounded-lg border border-secondary-foreground/20 bg-card-foreground/25 p-4 shadow-lg shadow-black/20">
